...
public class Pente : Obstacle
{
    ...
    public override Vector2 Interaction(Vector2 pos, Vector3 lossyScale, PlayerController playerController, RaycastHit2D raycastHit2D, Side UpDown, Side RightLeft)
    {
        ...
        switch (_lastSideUsed)
        {
            case Side.Up:
                ...
                playerController._directionMovement = transform.right;

                playerController.transform.RotateAround(raycastHit2D.point, Vector3.forward, Vector2.Angle(new Vector2(1, 0), transform.right));
                Debug.Log("Direction = " + playerController._directionMovement);
    ...
    public override void ExitInteraction(PlayerController playerController)
    {
        ...
        playerController._directionMovement = new Vector2(1, 0);
    }
}
